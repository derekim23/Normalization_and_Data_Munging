...
The overarching goal of this study is in the realm of multiomics data and how they relate to certain phenotypic measures. All of the underlying data and code has been sanitized. Omics data were collected before and after intense exercise: blood draw 1 (pre-exercise) vs. blood draws 2, 3, and 4 (post-exercise). The experiment and data collection were repeated twice more after the very first, resulting in a total of three sessions of four blood draws. There are some bits and pieces of the code files that are missing for confidentiality reasons. However, each indvidual code uploaded here can function with the original dataset (unavailable).
